...
generate_envdata() {
    ...
    envdata.js --output envdata.json --pretty --prefix MC_
...
generate_config() {
    ...
    generate_envdata
    process.js config.json.template --data envdata.json > meshcentral-data/config.json
	echo "meshcentral-data/config.json generated successfully."
}
